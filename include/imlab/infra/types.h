...
class Integer {
 public:
    ...
    /// builder
    static Integer build(int32_t value) { return Integer(value); }
};
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
std::ostream& operator<<(std::ostream &out, const imlab::Integer &value);
//---------------------------------------------------------------------------
template <unsigned kMaxLen>
std::ostream& operator<<(std::ostream &out, const imlab::Varchar<kMaxLen> &value) {
...
//---------------------------------------------------------------------------
template <unsigned kMaxLen>
std::ostream& operator<<(std::ostream &out, const imlab::Char<kMaxLen> &value) {
    for (auto iter = value.begin(), limit = value.end(); iter != limit; ++iter)
        out << (*iter);
    return out;
}
...
std::ostream &operator<<(std::ostream &out, const imlab::Numeric<len, precision> &value) {
...
//---------------------------------------------------------------------------
std::ostream &operator<<(std::ostream &out, const imlab::Date &value);
//---------------------------------------------------------------------------
std::ostream& operator<<(std::ostream &out, const imlab::Timestamp &value);
//---------------------------------------------------------------------------
namespace std {
//---------------------------------------------------------------------------
template<>
struct hash<imlab::Integer> {
    std::size_t operator()(const imlab::Integer& i) const { return i.hash(); }
};
//---------------------------------------------------------------------------
template<>
struct hash<imlab::Date> {
    std::size_t operator()(const imlab::Date& d) const { return d.hash(); }
};
//---------------------------------------------------------------------------
template<>
struct hash<imlab::Timestamp> {
    std::size_t operator()(const imlab::Timestamp& t) const { return t.hash(); }
};
//---------------------------------------------------------------------------
template<unsigned MaxLen>
struct hash<imlab::Varchar<MaxLen>> {
    std::size_t operator()(const imlab::Varchar<MaxLen>& v) const { return v.hash(); }
};
//---------------------------------------------------------------------------
template<unsigned MaxLen>
struct hash<imlab::Char<MaxLen>> {
    std::size_t operator()(const imlab::Char<MaxLen>& c) const { return c.hash(); }
};
//---------------------------------------------------------------------------
template <unsigned Len, unsigned Precision>
struct hash<imlab::Numeric<Len, Precision>> {
    std::size_t operator()(const imlab::Numeric<Len, Precision>& n) const { return n.hash(); }
};
//---------------------------------------------------------------------------
}  // namespace std
//---------------------------------------------------------------------------
